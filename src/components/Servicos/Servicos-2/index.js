    ...
    return (
        <Container>
            <BlocoTextForm>
                ...
                <Description style={{ marginTop: -20 }}>Visitas técnicas, visando um estudo do projeto inicial, onde serão realizados levantamentos em campo <br/> 
                ...
                <img style={{ marginLeft: 150, marginTop: 15 }} src={Photo} height="280" />
            </BlocoTextForm>
        </Container>
    )
}